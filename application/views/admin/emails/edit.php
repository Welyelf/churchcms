                ...
                <div class="row">
                    <div class="col-lg-10 col-lg-offset-1">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="name" value="<?php echo $email->name; ?>"
                                   required/>
                            <?php echo form_error('name'); ?>
                        </div>
                        <div class="form-group">
                            <label class="control-label">Slug</label>
                            <input type="text" class="form-control" name="slug" value="<?php echo $email->slug; ?>"
                                   required/>
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="ckeditor" class="form-control" name="template"
                                      required><?php echo $email->template; ?></textarea>
