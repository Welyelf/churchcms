                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="nice_name"
                                           value="<?php echo set_value("nice_name"); ?>"/>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4">
                                            <input type="checkbox" id="is-fixed" name="is_fixed" checked
                                                   data-toggle="toggle" data-on="Fixed" data-off="Variable"
                                                   data-onstyle="success" data-offstyle="danger" value="1">
                                        </div>
                                        <div class="col-lg-8">
                                            <div class="input-group" id="amt-container">
                                                <span class="input-group-addon"><strong>$</strong></span>
                                                <input type="number" id="amt" class="form-control" name="amount"
                                                       value="<?php echo set_value("amount"); ?>" step=".01" required/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
