    ...
    $(document).ready(function () {
        ...
        var handler = StripeCheckout.configure({
            ...
            token: function (token) {
                $.ajax({
                    ...
                    data: {stripeToken: token.id, stripeEmail: token.email, donationAmt: donationAmt, plan: 'none'},
                    success: function (data) {
                        ...
                        if (data.error != '') {
                            ...
                            document.getElementById("transcription-order-form").submit();
        ...
        $('#donateNow').click(function (e) {
            ...
            if (document.getElementById('client_name').value == "" ||
                ...
                (document.getElementById('youtube_link').value == "" && document.getElementById('video_file').value == "")) {

                alert("Your Name, Your Email and Youtube Link or Video Upload is required!");
